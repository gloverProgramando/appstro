    ...
    <div class="container-fluid d-flex align-items-center justify-content-center" style="padding: 5%">
        <div class="row">
            <div class="col-sm-10 col-md-8 col-lg-6 mx-auto">
                <div class="contenido">
                    <h2>Planetas en plataforma</h2>
                </div>
            </div>
            <table id="astros_tipo" class="table table-striped">
                <thead>
                    <tr>
                        <th> Nombre tipo Astro</th>
                        <th> Imagen del tipo de astro</th>
                        <th> Acciones</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($datos as $tipos_astros)
                    <tr>
                        <td>{{$tipos_astros['type_astro']}}</td>
                        <td><img src="{{$tipos_astros['img_type_astrourl']}}" width="200" height="100"></td>
                        <td>
