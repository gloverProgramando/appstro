    ...
    <div class="container-fluid d-flex align-items-center justify-content-center" style="padding: 5%">
        <div class="row">
            ...
            <table id="usuarios" class="table table-striped">
                <thead>
                    <div>
                        <a href="{{ Route('registrar_nuevo_usuario') }}" class="btn btn-primary">Registrar Nuevo
                            Usuario</a>
                    </div>
                    <tr>
                        <th> Nombre </th>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-center">
                                <form action="" style="padding: 1%">
                                    @csrf
                                    <button type="submit" class="btn btn-primary"> Editar <i
                                            class="zmdi zmdi-edit"></i></button>
                                </form>
                                <form action="" style="padding: 1%"
                                    method="POST">
                                    @csrf
                                    <button type="submit" class="btn btn-primary"> Eliminar <i
                                            class="zmdi zmdi-edit"></i></button>
                                </form>
                            </td>
                        </tr>
